...
def species_params():
    return {
        ...
        "sp_curve": {
            ...
            "season_curve": dict(zip(range(1, 13),
                              [0.2, 0.2, 0.3, 0.5, 0.8, 1.0, 1.0, 0.9, 0.7, 0.5, 0.3, 0.2], strict=True)),
        },
    }
...
def zone_curves():
    ...
    return {"boreal": {"sp_curve": {m: float(v) for m, v in zip(range(1, 13),
                        [0.1, 0.1, 0.2, 0.4, 0.7, 1.0, 1.0, 0.8, 0.6, 0.4, 0.2, 0.1], strict=True)}}}
