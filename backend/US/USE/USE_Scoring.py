...
geojson_path          = get_required_env("USE_BOUNDARIES_DATA")
coordinates_file_path = get_required_env("USE_UNIQUE_COORDINATES")
base_file_path        = get_required_env("USE_BASE_DATA")
species_params_path   = get_required_env("USE_SPECIES_PARAMS")
main_data_path        = get_required_env("USE_WEATHER_DATA")
static_info_path      = get_required_env("US_STATIC_INFO")

NDP = 3  # decimals to keep (≈100–120 m)

lat_start, lat_end = 24.0, 37.5
lon_start, lon_end = -106.5, -75.0
lat_step = 0.060
lon_step = 0.075
...
# to R2 at US_ZONE_SEASON_CURVES). Keyed climate_zone -> species -> {month: multiplier}.
...
_zone_curves_path = os.getenv("US_ZONE_SEASON_CURVES")
zone_curves = {}
