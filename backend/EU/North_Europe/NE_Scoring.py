...
geojson_path          = get_required_env("NE_BOUNDARIES_DATA")
coordinates_file_path = get_required_env("NE_UNIQUE_COORDINATES")
base_file_path        = get_required_env("NE_BASE_DATA")
species_params_path   = get_required_env("NE_SPECIES_PARAMS")
main_data_path        = get_required_env("NE_WEATHER_DATA")
static_info_path      = get_required_env("EU_STATIC_INFO")

NDP = 3  # decimals to keep (≈100–120 m)

lat_start, lat_end = 49.0, 71.5
lon_start, lon_end = -25.0, 32.0
lat_step = 0.060
lon_step = 0.075
