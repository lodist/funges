...
geojson_path          = get_required_env("SE_BOUNDARIES_DATA")
coordinates_file_path = get_required_env("SE_UNIQUE_COORDINATES")
base_file_path        = get_required_env("SE_BASE_DATA")
species_params_path   = get_required_env("SE_SPECIES_PARAMS")
main_data_path        = get_required_env("SE_WEATHER_DATA")
static_info_path      = get_required_env("EU_STATIC_INFO")

NDP = 3  # decimals to keep (≈100–120 m)

lat_start, lat_end = 34.0, 55.5
lon_start, lon_end = 12.0, 42.5
lat_step = 0.060
lon_step = 0.075
