...
region_code = 'usw'
REGION = "USW"
REGION_LAT_RANGE = (33.0, 49.5)
REGION_LON_RANGE = (-125.5, -81.5)
...
GEOJSON_FILE_PATH = get_required_env("USW_WILDERNESS_DATA_SOURCE")
...
CLIPPED_TRIANGLES_PATH = get_required_env("USW_CLIPPED_GPKG")
