...
Expected: filenames like `Cantharellus_cibarius_<obsid>_<photoid>.jpg`, count 110 — and the count of distinct files must EQUAL the manifest row count (the stage now raises if not).
