      ...
      <DialogContent className='flex max-h-[85vh] w-full max-w-4xl flex-col'>
        <header className='flex shrink-0 items-start gap-6 pr-8'>
          ...
          <div className='min-w-0 flex-1 space-y-2'>
            ...
            <DialogDescription className='flex flex-wrap items-center gap-x-5 gap-y-1.5 text-sm text-muted-foreground'>
        ...
        <div className='min-h-0 flex-1 space-y-6 overflow-y-auto pr-1 pt-6'>
          <section>
            ...
            <ul className='grid list-disc grid-cols-2 gap-x-8 gap-y-1.5 pl-5 marker:text-foreground'>
