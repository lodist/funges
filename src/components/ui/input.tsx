  ...
  return (
    <input
      ...
      className={cn(
        ...
        'file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 flex h-12 w-full min-w-0 rounded-full border border-border bg-card px-4 py-1 text-base elevation-raised-subtle transition-[color,box-shadow] focus-ring file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:border-happy-500 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
